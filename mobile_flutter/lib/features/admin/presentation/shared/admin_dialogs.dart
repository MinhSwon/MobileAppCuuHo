...
Future<Map<String, dynamic>?> pickRescueTeam(
    ...
    builder: (context) => SafeArea(
      child: ListView(
        ...
        children: [
          const PageTitle(
            'Chọn đội cứu hộ',
            'Ưu tiên đội đang sẵn sàng và gần khu vực sự cố',
          ),
                  ...
                  child: InkWell(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InfoRow(
                          'Trưởng đội',
                          valueOf(team, 'leader_name', fallback: '-'),
                        ),
                        InfoRow(
                          'Điện thoại',
                          valueOf(team, 'phone', fallback: '-'),
                        ),
                        InfoRow(
                          'Thành viên',
                          '${valueOf(team, 'member_count', fallback: '0')} người',
                        ),
                      ],
                    ),
                  ),
